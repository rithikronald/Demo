  ...
  return (
    <>
      <div className="bg-gradient-to-b from-fuchsia-500 to-cyan-500 w-full h-[75%] rounded-2xl p-0.5 my-5 3xl:h-[60%]">
        <div className="bg-bg w-full h-full rounded-2xl flex flex-col justify-around py-10 p-4">
          <div>
            ...
            <GradientContainer
              ...
              children={
                <div className="flex px-4">
                  ...
                  <input
                    type="text"
                    className="h-full w-full bg-transparent text-white text-3xl ml-2 font-bold rounded-2xl text-center form-control"
                  />
                </div>
              }
            />
      ...
      <div className="flex space-x-2">
        <button onClick={()=>props?.onClick()} className="bg-gradient-to-r from-purple-300 bg-purple-400 text-white p-4 font-medium rounded-lg w-full h-14 shadow-lg text-xl flex justify-center items-center">
          Go Back
        </button>
