...
const Modal = (props) => {
  ...
  return props.modalOpen ? (
    <div
      className="fixed h-[100vh] top-0 left-0 w-[100vw] z-[100]"
      //   onClick={() => props.setModalOpen(!props.modalOpen)}
    >
      <div className="flex flex-col items-center justify-center absolute top-0 right-0 h-[100vh] w-[500px] bg-bgl2 z-[100]">
        <div className="flex w-[200px] justify-around mb-[60px]">
          <p className="font-mont text-white text-[15px] relative cursor-pointer" onClick={() => setBuy(true)}>
            BUY
            {buy && <div className="absolute -bottom-[10px] left-1/2 -translate-x-1/2 w-14 h-2 bg-orange-500 rounded-3xl"></div>}
          </p>
          <p className="font-mont text-white text-[15px] relative cursor-pointer" onClick={() => setBuy(false)}>
            SELL
            {!buy && <div className="absolute -bottom-[10px] left-1/2 -translate-x-1/2 w-14 h-2 bg-orange-500 rounded-3xl"></div>}
          </p>
        </div>
        <div className="priceBorder p-[1px]">
          <div className="bg-bgl2 priceBorderOnly flex flex-col w-[336px] items-center p-[10px]">
            ...
            <div>
              <p className="font-mont text-white text-[10px] pl-4 mt-6">
                Price
              </p>
